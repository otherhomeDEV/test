...
for ($i=0; $i < $list_cnt; $i++) { 
	...
	// No 이미지
	$no_img = '/theme/BS4-Basic/storage/image/no-image.png';

	// 썸네일 생성
	$thumb = ($wset['thumb_w']) ? na_thumb($img, $wset['thumb_w'], $wset['thumb_h']) : $img;
	if(!$thumb && $no_img) { $thumb = $no_img; }

?>
	<li class="col px-2 pb-4">
		<div class="img-wrap bg-light mb-2" style="padding-bottom:<?php echo $img_height ?>%; border-radius : 10px;">
			<div class="img-item">
