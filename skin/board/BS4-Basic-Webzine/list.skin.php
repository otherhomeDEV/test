							...
							<?php if($thumb) { ?>
								<div class="order-1<?php echo $img_loc ?> col-12<?php echo $img_cols ?>">
									<div class="mx-3 mx-sm-0 mb-3 mb-sm-0">
										<div class="img-wrap bg-light" style="padding-bottom:<?php echo $img_height ?>%;">
											<div class="img-item">
												<?php if ($is_checkbox) { ?>
													<span class="chk-box">
												...
												<a href="<?php echo $list[$i]['href'] ?>"<?php echo $target ?>>
													...
													<?php echo $wr_tack ?>
													<?php echo $wr_cap ?>
													<img src="<?php echo $thumb ?>" alt="<?php echo $wr_alt ?>" class="img-render" style="border-radius: 18px;">
												</a>
											</div>
										</div>
									</div>
