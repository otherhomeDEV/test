...
<!-- PC 상단 메뉴 -->
<nav id="nt_menu" class="nt-menu bg-primary border-primary rounded-pill d-none d-md-block font-weight-normal">
	...
	<div class="nt-container">
		<div class="d-flex<?php echo $menu_flex ?>">
			...
			<div class="me-icon order-1 me-li<?php echo $menu_head ?>">
