...
<div class="wrapper <?php echo ($is_layout) ? $is_layout : 'wided'; ?>">
	<div id="nt_header">
		...
		<div id="nt_sticky">
			...
			<!-- PC 헤더 시작 { -->
			<header id="header_pc" class="d-none d-md-block" style="margin: 20px 0;">
				<div class="nt-container px-3 px-sm-4 px-xl-0 d-flex justify-content-center">
					<div class="d-flex">
						...
						<div class="align-self-center ">
							<div class="header-search">
								<form name="tsearch" method="get" action="<?php echo G5_BBS_URL ?>/search.php" onsubmit="return tsearch_submit(this);" class="border-primary rounded-pill" >
									<input type="hidden" name="sfl" value="wr_subject||wr_content">
									<input type="hidden" name="sop" value="and">
									<div class="input-group input-group-lg">
										<input type="text" name="stx" class="form-control en" style="margin-left:20px;" value="<?php echo $stx ?>">
						...
						<div class="align-self-center px-4">
							<!-- 배너 등 우측 영역 컨텐츠 -->
						  <div id="ww_9b73f36483aa6" style="width: 290px;" v='1.3' loc='id' a='{"t":"horizontal","lang":"ko","sl_lpl":1,"ids":["wl3633"],"font":"Arial","sl_ics":"one_a","sl_sot":"celsius","cl_bkg":"#FFFFFF00","cl_font":"#000000","cl_cloud":"#d4d4d4","cl_persp":"#2196F3","cl_sun":"#FFC107","cl_moon":"#FFC107","cl_thund":"#FF5722","el_phw":3,"el_whr":3}'>More forecasts: <a href="https://oneweather.org/sydney/30_days/" id="ww_9b73f36483aa6_u" target="_blank">Weather forecast Sydney 30 days</a></div><script async src="https://app2.weatherwidget.org/js/?id=ww_9b73f36483aa6"></script>
						</div>
					</div>
				</div>
			</header>
			...
			<div id="nt_sticky_wrap">
				...
				<header id="header_mo" class="d-block d-md-none">
				    <div class="header-logo" style="text-align: center; margin-top: 20px; margin-bottom: 20px;">
                         <a href="<?php echo NT_HOME_URL ?>" style="display: inline-block; vertical-align: middle;">
                            <img id="logo_img" src="<?php echo $tset['logo_img'] ?>" alt="<?php echo get_text($config['cf_title']) ?>">
                        </a>
                    </div>
