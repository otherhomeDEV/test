...
<ul class="list-group">
	...
	<li class="list-group-item">
		<div class="form-group row mb-0">
			<label class="col-sm-2 col-form-label">추출 옵션(큰이미지)</label>
			<div class="col-sm-10">
				<div class="table-responsive">
					<table class="table table-bordered mb-0">
					<tbody>
					...
					<tr>
					<td class="text-center">큰이미지글</td>
					<td>
						<?php $wset['irows'] = isset($wset['irows']) ? $wset['irows'] : ''; ?>
						<select name="wset[irows]" class="custom-select">
					...
					<td class="text-muted">기본값 : 120자</td>
					</tr>

					<tr>
					<td class="text-center">글내용 줄</td>
					<td>
						<div class="input-group">
							<?php $wset['line'] = isset($wset['line']) ? $wset['line'] : ''; ?>
							<input type="text" name="wset[line]" value="<?php echo $wset['line'] ?>" class="form-control">
							<div class="input-group-append">
					...
					<tr>
					<td class="text-center">하단간격</td>
					<td>
						<div class="input-group">
							<?php $wset['bh'] = isset($wset['bh']) ? $wset['bh'] : ''; ?>
							<input type="text" name="wset[bh]" value="<?php echo $wset['bh'] ?>" class="form-control">
							<div class="input-group-append">
								<span class="input-group-text">px</span>
							</div>
						</div>
					...
					<td>
						<div class="input-group">
							<?php $wset['sthumb_w'] = isset($wset['sthumb_w']) ? $wset['sthumb_w'] : ''; ?>
							<input type="text" name="wset[sthumb_w]" value="<?php echo $wset['sthumb_w'] ?>" class="form-control">
							<div class="input-group-append">
								<span class="input-group-text">px</span>
							</div>
						</div>
					</td>
					<td class="text-muted">기본값 : 100 - 0 설정시 썸네일 생성 안 함</td>
					</tr>
					<tr>
					<td class="text-center">썸네일 높이</td>
					<td class="text-center">
						<div class="input-group">
							<?php $wset['sthumb_h'] = isset($wset['sthumb_h']) ? $wset['sthumb_h'] : ''; ?>
							<input type="text" name="wset[sthumb_h]" value="<?php echo $wset['sthumb_h'] ?>" class="form-control">
							<div class="input-group-append">
								<span class="input-group-text">px</span>
							</div>
						</div>
					</td>
					<td class="text-muted">기본값 : 81 - 0 설정시 이미지 비율대로 생성</td>
					</tr>
					<tr>
					<td class="text-center">기본 높이</td>
					<td>
						<div class="input-group">
							<?php $wset['sthumb_d'] = isset($wset['sthumb_d']) ? $wset['sthumb_d'] : ''; ?>
							<input type="text" name="wset[sthumb_d]" value="<?php echo $wset['sthumb_d'] ?>" class="form-control">
							<div class="input-group-append">
								<span class="input-group-text">%</span>
							</div>
						</div>
